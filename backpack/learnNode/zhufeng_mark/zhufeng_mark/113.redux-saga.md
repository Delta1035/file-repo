...
---
## 1. Generator [#](#t01-generator)

### 1.1 Generator [#](#t111-generator)
...
![](https://img.zhufengpeixun.com/generatororiginal.png)

![](https://img.zhufengpeixun.com/generatorexecflow.png)
...
##### 1.7.2.1 generator.js [#](#t81721-generatorjs)
...
##### 1.7.2.2 regeneratorRuntime.js [#](#t91722-regeneratorruntimejs)
...
## 2. redux-saga实战 [#](#t102-redux-saga实战)

### 2.1 初始化项目 [#](#t1121-初始化项目)
...
### 2.2 实现计数器 [#](#t1222-实现计数器)

#### 2.2.1 action-types.js [#](#t13221-action-typesjs)
...
#### 2.2.2 reducer.js [#](#t14222-reducerjs)
...
#### 2.2.3 store\index.js [#](#t15223-storeindexjs)
...
#### 2.2.4 actions.js [#](#t16224-actionsjs)
...
#### 2.2.5 Counter.js [#](#t17225-counterjs)
...
#### 2.2.6 src\index.js [#](#t18226-srcindexjs)
...
### 2.3 saga计数器 [#](#t1923-saga计数器)

#### 2.3.1 src\store\sagas.js [#](#t20231-srcstoresagasjs)
...
#### 2.3.2 action-types.js [#](#t21232-action-typesjs)
...
#### 2.3.3 actions.js [#](#t22233-actionsjs)
...
#### 2.3.4 src\store\index.js [#](#t23234-srcstoreindexjs)
...
### 3.2 middleware.js [#](#t2632-middlewarejs)
...
### 3.3 channel.js [#](#t2733-channeljs)
...
### 3.4 runSaga.js [#](#t2834-runsagajs)
...
#### 3.5 effectTypes.js [#](#t2935-effecttypesjs)
...
### 3.6 effectRunnerMap.js [#](#t3036-effectrunnermapjs)
...
### 3.7 effects.js [#](#t3237-effectsjs)
...
## 4. 支持产出iterator [#](#t334-支持产出iterator)

### 4.1 sagas.js [#](#t3441-sagasjs)
...
## 5. 支持takeEvery [#](#t375-支持takeevery)
...
### 5.2 effectTypes.js [#](#t3952-effecttypesjs)
...
### 5.3 effects.js [#](#t4053-effectsjs)
...
### 5.4 effectRunnerMap.js [#](#t4154-effectrunnermapjs)
...
## 6 支持promise [#](#t426-支持promise)

### 6.1 sagas.js [#](#t4361-sagasjs)
...
* 异步阻塞调用**7.1 sagas.js [#](#t4771-sagasjs)**src\store\sagas.js `````diff +import { put, takeEvery,call} from '../redux-saga/effects'; //import { put, takeEvery,call} from 'redux-saga/effects'; import * as actionTypes from './action-types'; const delay=ms => new Promise((resolve,reject) => { setTimeout(() => {
...
**  7.3 effects.js [#](#t4873-effectsjs)**
...
**  7.4 effectRunnerMap.js [#](#t4974-effectrunnermapjs)**
...
**  8.3 effectTypes.js [#](#t5383-effecttypesjs)**
...
**  8.4 effects.js [#](#t5484-effectsjs)**
...
**  8.5 effectRunnerMap.js [#](#t5585-effectrunnermapjs)**
...
**  9.2 effectTypes.js [#](#t5892-effecttypesjs)**
...
**  9.3 effects.js [#](#t5993-effectsjs)**
...
**  9.5 effectRunnerMap.js [#](#t6195-effectrunnermapjs)**
...
**  10.2 effectTypes.js [#](#t64102-effecttypesjs)**
...
**  10.3 effects.js [#](#t65103-effectsjs)**
...
**  10.4 effectRunnerMap.js [#](#t66104-effectrunnermapjs)**
...
**  10.5 symbols.js [#](#t67105-symbolsjs)**
...
**  10.7 action-types.js [#](#t69107-action-typesjs)**
...
**  10.8 actions.js [#](#t70108-actionsjs)**
...
**  10.9 Counter.js [#](#t71109-counterjs)**
