...
---
## 1. rollup实战 [#](#t01-rollup实战)

* [rollupjs](https://rollupjs.org/guide/en/)是下一代ES模块捆绑器**1.1 背景[#](#t111-背景)**
...
#### 1.3.1 rollup.config.js [#](#t4131-rollupconfigjs)
...
#### 1.3.2 src\main.js [#](#t5132-srcmainjs)
...
#### 1.3.3 package.json [#](#t6133-packagejson)
...
#### 1.3.4 dist\index.html [#](#t7134-distindexhtml)
...
**  1.4 支持babel [#](#t814-支持babel)**

* 为了使用新的语法，可以使用babel来进行编译输出

#### 1.4.1 安装依赖 [#](#t9141-安装依赖)
...
#### 1.4.2 src\main.js [#](#t10142-srcmainjs)
...
#### 1.4.4 rollup.config.js [#](#t12144-rollupconfigjs)
...
**  1.5 tree-shaking [#](#t1315-tree-shaking)**

* Tree-shaking的本质是消除无用的js代码
* rollup只处理函数和顶层的import/export变量

#### 1.5.1 src\main.js [#](#t14151-srcmainjs)
...
#### 1.5.2 src\msg.js [#](#t15152-srcmsgjs)
...
#### 1.6.3 rollup.config.js [#](#t19163-rollupconfigjs)
...
**  1.7 使用CDN [#](#t2017-使用cdn)**

#### 1.7.1 src\main.js [#](#t21171-srcmainjs)
...
#### 1.7.2 dist\index.html [#](#t22172-distindexhtml)
...
#### 1.7.3 rollup.config.js [#](#t23173-rollupconfigjs)
...
**  1.8 使用typescript [#](#t2418-使用typescript)**
...
#### 1.8.2 src\main.ts [#](#t26182-srcmaints)
...
#### 1.8.3 rollup.config.js [#](#t27183-rollupconfigjs)
...
#### 1.8.4 tsconfig.json [#](#t28184-tsconfigjson)
...
#### 1.9.2 rollup.config.js [#](#t31192-rollupconfigjs)
...
**  1.10 编译css [#](#t32110-编译css)**

* terser是支持ES6 +的JavaScript压缩器工具包

#### 1.10.1 安装 [#](#t331101-安装)

```js
cnpm install  postcss rollup-plugin-postcss --save-dev
```

#### 1.10.2 rollup.config.js [#](#t341102-rollupconfigjs)
...
#### 1.10.3 src\main.js [#](#t351103-srcmainjs)
...
#### 1.10.4 src\main.css [#](#t361104-srcmaincss)
...
**  1.11 本地服务器 [#](#t37111-本地服务器)**

#### 1.11.1 安装 [#](#t381111-安装)

```js
cnpm install rollup-plugin-serve --save-dev
```

#### 1.11.2 rollup.config.dev.js [#](#t391112-rollupconfigdevjs)
...
#### 1.11.3 package.json [#](#t401113-packagejson)
...
**  2.1. 初始化项目 [#](#t4221-初始化项目)**

```js
cnpm install magic-string acorn --save
```

**  2.2. magic-string [#](#t4322-magic-string)**
...
##### 2.3.2.1 walk.js [#](#t472321-walkjs)
...
##### 2.4.2.2 useScope.js [#](#t532422-usescopejs)
...
**  3.2 src\main.js [#](#t5632-srcmainjs)**
...
**  3.3 debugger.js [#](#t5733-debuggerjs)**
...
**  3.7 analyse.js [#](#t6137-analysejs)**
...
## 4. 实现tree-shaking [#](#t624-实现tree-shaking)
...
![](https://img.zhufengpeixun.com/4324fd261744db779245477d4cc336a6)
**  4.2 src\main.js [#](#t6442-srcmainjs)**
...
![](https://img.zhufengpeixun.com/d6bcbc174f98e9aa834ea48397efb177)
**  4.3 bundle.js [#](#t6543-bundlejs)**
...
**  4.7 analyse.js [#](#t7047-analysejs)**
...
## 5. 包含修改语句 [#](#t715-包含修改语句)

**  5.1 src\index.js [#](#t7251-srcindexjs)**
...
**  5.3 lib\module.js [#](#t7453-libmodulejs)**
...
**  5.4 analyse.js [#](#t7554-analysejs)**
...
## 6. 支持块级作用域和入口treeshaking [#](#t766-支持块级作用域和入口treeshaking)

**  6.1 src\main.js [#](#t7761-srcmainjs)**
...
**  6.3 analyse.js [#](#t7963-analysejs)**
...
## 7. 实现变量名重命名 [#](#t817-实现变量名重命名)

**  7.1 src\main.js [#](#t8271-srcmainjs)**
...
**  7.2 src\age1.js [#](#t8372-srcage1js)**
...
**  7.3 src\age2.js [#](#t8473-srcage2js)**
...
**  7.5 lib\utils.js [#](#t8675-libutilsjs)**
...
**  7.6 analyse.js [#](#t8776-analysejs)**
...
**  7.8 lib\bundle.js [#](#t8978-libbundlejs)**
