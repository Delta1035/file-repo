...
## 1.Ant Design Pro [#](#t01ant-design-pro)
...
#### 2.2.1 config\proxy.ts [#](#t6221-configproxyts)
...
#### 2.2.2 src\services\API.d.ts [#](#t7222-srcservicesapidts)
...
#### 2.2.3 login\index.tsx [#](#t8223-loginindextsx)
...
#### 2.2.7 AvatarDropdown.tsx [#](#t12227-avatardropdowntsx)
...
## 3. 新增用户和用户列表 [#](#t133-新增用户和用户列表)

### 3.1 config\routes.ts [#](#t1431-configroutests)
...
### 3.4 service.ts [#](#t1734-servicets)
...
### 3.5 user\index.tsx [#](#t1835-userindextsx)
...
### 3.7 CreateForm.tsx [#](#t2037-createformtsx)
...
### 4.1 UpdateForm.tsx [#](#t2241-updateformtsx)
...
### 2.4 routes\user.js [#](#t2924-routesuserjs)
...
### 3.1 routes\user.js [#](#t3131-routesuserjs)
...
### 4.1 checkLogin.js [#](#t3341-checkloginjs)
...
### 4.2 checkPermission.js [#](#t3442-checkpermissionjs)
...
### 4.3 routes\user.js [#](#t3543-routesuserjs)
