...
date: null
publisher: 珠峰架构师成长计划
stats: paragraph=311 sentences=1420, words=6626
---
## 1. 项目说明 [#](#t01-项目说明)

## 1.1 项目目录结构 [#](#t111-项目目录结构)

* src 项目源码目录
* index.js 入口文件
* containers 容器
* components 组件
* common 公共样式**1.2 存入Redux [#](#t212-存入redux)**
* 编写服务端接口
* 用fetch获取接口方法
...
### 2.1 src/index.html [#](#t521-srcindexhtml)

```diff
+
```

### 2.2 src/index.tsx [#](#t622-srcindextsx)
...
### 2.3 webpack.config.js [#](#t723-webpackconfigjs)
...
### 2.4 common/common.less [#](#t824-commoncommonless)
...
### 2.5 containers/App.tsx [#](#t925-containersapptsx)
...
### 2.6 Tab/index.tsx [#](#t1026-tabindextsx)
...
### 2.7 Tab/index.less [#](#t1127-tabindexless)
...
### 2.8 Home/index.tsx [#](#t1228-homeindextsx)
...
### 2.9 Lesson/index.tsx [#](#t1329-lessonindextsx)
...
### 2.10 Profile/index.tsx [#](#t14210-profileindextsx)
...
**  3. 首页头部动画 [#](#t153-首页头部动画)**

### 3.1 types/index.tsx [#](#t1631-typesindextsx)
...
### 3.2 webpack.config.js [#](#t1732-webpackconfigjs)
            ...
            <div className="home-header">
                ...
                <TransitionGroup>
                        ...
                        ><ul className="menu-list" onClick={this.setCurrentCategory}>
                                    <li data-category="react" className={currentCategory=='react'?'active':''}>Reactli>
                                    <li data-category="vue"  className={currentCategory=='vue'?'active':''}>Vueli>
                                ul>CSSTransition>
                        }
                TransitionGroup>
            div>
...
### 4.2 Home/index.tsx [#](#t2242-homeindextsx)
...
### 4.3 store/action-types.tsx [#](#t2343-storeaction-typestsx)
...
### 4.4 reducers/index.tsx [#](#t2444-reducersindextsx)
...
### 4.5 types/index.tsx [#](#t2545-typesindextsx)
...
### 4.6 actions/home.tsx [#](#t2646-actionshometsx)
...
### 4.7 reducers/home.tsx [#](#t2747-reducershometsx)
...
### 5.1 HomeSwiper/index.tsx [#](#t2951-homeswiperindextsx)
...
### 5.2 HomeSwiper/index.less [#](#t3052-homeswiperindexless)
...
### 5.3 server/app.js [#](#t3153-serverappjs)
...
### 5.4 src/api/index.tsx [#](#t3254-srcapiindextsx)
...
### 5.5 api/home.tsx [#](#t3355-apihometsx)
...
### 5.6 server/app.js [#](#t3456-serverappjs)
...
### 5.7 server/mock/sliders.js [#](#t3557-servermockslidersjs)
...
### 6.1 server/app.js [#](#t3761-serverappjs)
...
### 6.2 mock/lessons.js [#](#t3862-mocklessonsjs)
...
### 6.3 api/home.tsx [#](#t3963-apihometsx)
...
### 6.5 Home/index.tsx [#](#t4165-homeindextsx)
...
### 6.6 store/action-types.tsx [#](#t4266-storeaction-typestsx)
...
### 6.7 actions/home.tsx [#](#t4367-actionshometsx)
...
### 6.8 reducers/home.tsx [#](#t4468-reducershometsx)
...
### 6.9 types/index.tsx [#](#t4569-typesindextsx)
...
### 6.10 Loading/index.tsx [#](#t46610-loadingindextsx)
...
### 6.11 HomeLessons/index.tsx [#](#t47611-homelessonsindextsx)
                ...
                div>
                {
                    list.length>0?list.map((item:any,index:number)=>(
                        <Link key={index} to={{pathname:`/detail/${item.id}`,state:item}}>
                            ...
                            div>
                        Link>
                    )):<div className="no-data">暂无数据div>
                }
                {
                    loading?<Loading/>:(!hasMore&& <div className="loading-more" >到底了div>)
                }
            div>
        )
    }
...
### 6.12 HomeLessons/index.less [#](#t48612-homelessonsindexless)
...
### 7.1 server/app.js [#](#t5071-serverappjs)
...
### 7.2 Loading/index.less [#](#t5172-loadingindexless)
...
### 7.3 Loading/index.tsx [#](#t5273-loadingindextsx)
...
### 7.4 HomeLessons/index.tsx [#](#t5374-homelessonsindextsx)
    ...
    render(){
        ...
        return (
            <div className="home-lessons">
                ...
                {
                    loading?<Loading/>:(hasMore?<div className="loading-more" onClick={getLessons} >加载更多div>:<div className="loading-more">木有了div>)
                }
            div>
        )
    }
...
### 7.5 Home/index.tsx [#](#t5475-homeindextsx)
...
### 7.6 store/action-types.tsx [#](#t5576-storeaction-typestsx)
...
### 7.7 actions/home.tsx [#](#t5677-actionshometsx)
...
### 7.8 reducers/home.tsx [#](#t5778-reducershometsx)
...
### 7.11 HomeSwiper/index.tsx [#](#t60711-homeswiperindextsx)
...
### 8.1 Home/index.tsx [#](#t6281-homeindextsx)
...
### 8.2 src/utils.tsx [#](#t6382-srcutilstsx)
...
### 9.1 src/index.tsx [#](#t6591-srcindextsx)
...
### 9.4 Detail/index.tsx [#](#t6894-detailindextsx)
...
### 9.5 Detail/index.less [#](#t6995-detailindexless)
...
**  10. 记住滚动条位置 [#](#t7010-记住滚动条位置)**

### 10.1 Home/index.tsx [#](#t71101-homeindextsx)
...
### 10.2 src/utils.tsx [#](#t72102-srcutilstsx)
...
### 11.1 Profile/index.tsx [#](#t74111-profileindextsx)
...
### 11.2 Profile/index.less [#](#t75112-profileindexless)
...
### 12.1 src/index.tsx [#](#t77121-srcindextsx)
...
### 12.2 Login/index.tsx [#](#t78122-loginindextsx)
...
### 12.3 Login/index.less [#](#t79123-loginindexless)
...
### 13.1 src/index.tsx [#](#t81131-srcindextsx)

```diff

```

### 13.2 Reg/index.tsx [#](#t82132-regindextsx)
...
### 13.3 Reg/index.less [#](#t83133-regindexless)
...
### 14.1 server/app.js [#](#t85141-serverappjs)
...
### 14.2 src/api/index.tsx [#](#t86142-srcapiindextsx)
...
### 14.3 Login/index.tsx [#](#t87143-loginindextsx)
...
### 14.4 Profile/index.tsx [#](#t88144-profileindextsx)
...
### 14.5 Reg/index.tsx [#](#t89145-regindextsx)
...
### 14.6 action-types.tsx [#](#t90146-action-typestsx)
...
### 14.7 reducers/index.tsx [#](#t91147-reducersindextsx)
...
### 14.8 types/index.tsx [#](#t92148-typesindextsx)
...
### 14.9 api/session.tsx [#](#t93149-apisessiontsx)
...
### 14.10 actions/session.tsx [#](#t941410-actionssessiontsx)
...
### 14.11 reducers/session.tsx [#](#t951411-reducerssessiontsx)
...
**  15. 受保护路由 [#](#t9615-受保护路由)**

### 15.1 PrivateRoute/index.tsx [#](#t97151-privaterouteindextsx)
...
### 15.2 src/index.tsx [#](#t98152-srcindextsx)
