...
![](https://img.zhufengpeixun.com/5f3ce0fe2ec27f8644983e7d8f31c367)
    ...
    <script>
        ...
        function dispatchEvent(event,isCapture){
            ...
            if(isCapture){
                ...
                for(let i=0;ilet handler = paths[i].onClick;
                    handler&&handler();
                }
            }
...
### 3.3 react-dom.js [#](#t1833-react-domjs)
...
### 4.1 react-dom.js [#](#t2041-react-domjs)
...
### 4.2 EventRegistry.js [#](#t2142-eventregistryjs)
...
### 4.3 DOMEventProperties.js [#](#t2243-domeventpropertiesjs)
...
### 4.4 SimpleEventPlugin.js [#](#t2344-simpleeventpluginjs)
...
### 4.5 DOMPluginEventSystem.js [#](#t2445-domplugineventsystemjs)
...
### 5.1 DOMPluginEventSystem.js [#](#t2651-domplugineventsystemjs)
...
### 5.2 EventSystemFlags.js [#](#t2752-eventsystemflagsjs)
...
### 5.3 EventListener.js [#](#t2853-eventlistenerjs)
...
### 5.4 ReactDOMComponentTree.js [#](#t2954-reactdomcomponenttreejs)
...
### 5.5 ReactDOMEventListener.js [#](#t3055-reactdomeventlistenerjs)
...
### 6.1 构建fiber树 [#](#t3261-构建fiber树)

![](https://img.zhufengpeixun.com/f5567dd756ad8b372fcdf12ece2477a8)

#### 6.1.1 react-dom.js [#](#t33611-react-domjs)
...
#### 6.1.3 ReactDOMComponentTree.js [#](#t35613-reactdomcomponenttreejs)
...
#### 6.1.4 ReactDOMEventListener.js [#](#t36614-reactdomeventlistenerjs)
...
### 6.2 收集事件函数 [#](#t3762-收集事件函数)

#### 6.2.1 ReactDOMEventListener.js [#](#t38621-reactdomeventlistenerjs)
...
#### 6.2.2 DOMPluginEventSystem.js [#](#t39622-domplugineventsystemjs)
...
#### 6.2.3 SimpleEventPlugin.js [#](#t40623-simpleeventpluginjs)
...
#### 6.2.4 getListener.js [#](#t41624-getlistenerjs)
...
#### 6.2.5 SyntheticEvent.js [#](#t42625-syntheticeventjs)
...
### 6.3 执行事件函数 [#](#t4363-执行事件函数)

#### 6.3.1 DOMPluginEventSystem.js [#](#t44631-domplugineventsystemjs)
...
### 7.1 ReactDOMUpdateBatching.js [#](#t4671-reactdomupdatebatchingjs)
...
### 7.2 ReactDOMEventListener.js [#](#t4772-reactdomeventlistenerjs)
...
## 8 支持onChange事件 [#](#t488-支持onchange事件)

### 8.1 src\index.js [#](#t4981-srcindexjs)
...
### 8.2 SyntheticEvent.js [#](#t5082-syntheticeventjs)
...
### 8.3 ChangeEventPlugin.js [#](#t5183-changeeventpluginjs)
...
### 8.4 DOMPluginEventSystem.js [#](#t5284-domplugineventsystemjs)
