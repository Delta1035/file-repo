...
link: null
title: 珠峰架构师成长计划
description: src\index.tsx
keywords: null
author: null
date: null
publisher: 珠峰架构师成长计划
stats: paragraph=375 sentences=1540, words=7396
---
## 1.搭建开发环境 [#](#t01搭建开发环境)

### 1.1 package.json [#](#t111-packagejson)
...
### 1.2 tsconfig.json [#](#t212-tsconfigjson)
...
### 1.3 webpack.config.js [#](#t313-webpackconfigjs)
...
### 1.4 src\index.tsx [#](#t414-srcindextsx)
...
### 1.5 src\index.html [#](#t515-srcindexhtml)
...
### 1.6 components\Counter1.tsx [#](#t616-componentscounter1tsx)
...
### 1.7 components\Counter2.tsx [#](#t717-componentscounter2tsx)
...
### 1.8 store\index.tsx [#](#t818-storeindextsx)
...
### 1.9 history.tsx [#](#t919-historytsx)
...
### 1.10 store\action-types.tsx [#](#t10110-storeaction-typestsx)
...
### 1.11 store\types\index.tsx [#](#t11111-storetypesindextsx)
...
### 1.12 store\reducers\index.tsx [#](#t12112-storereducersindextsx)
...
### 1.13 store\reducers\counter1.tsx [#](#t13113-storereducerscounter1tsx)
...
### 1.14 store\reducers\counter2.tsx [#](#t14114-storereducerscounter2tsx)
...
### 1.15 store\actions\counter1.tsx [#](#t15115-storeactionscounter1tsx)
...
### 1.16 store\actions\counter2.tsx [#](#t16116-storeactionscounter2tsx)
...
### 3.1 package.json [#](#t1931-packagejson)
...
### 3.2 webpack.config.js [#](#t2032-webpackconfigjs)
...
### 3.3 src/index.tsx [#](#t2133-srcindextsx)
...
### 3.4 common\index.less [#](#t2234-commonindexless)
...
### 3.5 components\Tab\index.tsx [#](#t2335-componentstabindextsx)
...
### 3.6 components\Tab\index.less [#](#t2436-componentstabindexless)
...
### 3.6 containers\App.tsx [#](#t2536-containersapptsx)
...
### 3.7 containers\Home\index.tsx [#](#t2637-containershomeindextsx)
...
### 3.8 containers\Mime\index.tsx [#](#t2738-containersmimeindextsx)
...
### 3.9 containers\Profile\index.tsx [#](#t2839-containersprofileindextsx)
...
## 4. 首页头部动画 [#](#t294-首页头部动画)

![](http://img.zhufengpeixun.cn/ketang1.png) ![](http://img.zhufengpeixun.cn/ketang1.png)

### 4.1 containers/Home/index.tsx [#](#t3041-containershomeindextsx)
...
### 4.2 webpack.config.js [#](#t3142-webpackconfigjs)
                ...
                <TransitionGroup>
                        {
                            ...
                            classNames="fade"
                              ><ul className="menu-list">
                                    <li data-category="1">React课程li>
                                    <li data-category="2">Vue课程li>
                                ul>CSSTransition>
                        }
                TransitionGroup>
            div>
...
### 4.5 types\index.tsx [#](#t3445-typesindextsx)
...
## 5. 当前分类存入redux [#](#t355-当前分类存入redux)

### 5.1 containers/Home/index.tsx [#](#t3651-containershomeindextsx)
...
### 5.2 store/action-types.tsx [#](#t3752-storeaction-typestsx)
...
### 5.3 store/action-types.tsx [#](#t3853-storeaction-typestsx)
...
### 5.4 store/reducers/index.tsx [#](#t3954-storereducersindextsx)
...
### 5.5 src\types\index.tsx [#](#t4055-srctypesindextsx)
...
### 5.6 store\actions\home.tsx [#](#t4156-storeactionshometsx)
...
### 5.7 store/actions/home.tsx [#](#t4257-storeactionshometsx)
...
### 5.8 store/reducers/home.tsx [#](#t4358-storereducershometsx)
...
### 5.1 containers/Home/index.tsx [#](#t4551-containershomeindextsx)
...
### 5.2 containers\Home\index.less [#](#t4652-containershomeindexless)
...
### 5.3 store/action-types.tsx [#](#t4753-storeaction-typestsx)
...
### 5.4 src/store/actions/home.tsx [#](#t4854-srcstoreactionshometsx)
...
### 5.5 store/reducers/home.tsx [#](#t4955-storereducershometsx)
...
### 5.6 src/types/index.tsx [#](#t5056-srctypesindextsx)
...
### 5.7 Home\components\Swiper\index.tsx [#](#t5157-homecomponentsswiperindextsx)
...
### 5.8 containers\Home\components\Swiper\index.less [#](#t5258-containershomecomponentsswiperindexless)
...
### 5.9 api\index.tsx [#](#t5359-apiindextsx)
...
### 5.10 api\home.tsx [#](#t54510-apihometsx)
...
### 5.11 server\app.js [#](#t55511-serverappjs)
...
### 5.12 server\mock\sliders.js [#](#t56512-servermockslidersjs)
...
### 6.1 server/mock/lessons.js [#](#t5861-servermocklessonsjs)
...
### 6.2 server/app.js [#](#t5962-serverappjs)
...
### 6.3 api/home.tsx [#](#t6063-apihometsx)
                ...
                <TransitionGroup>
                    {
                        ...
                        >
                            <ul className="menu-list" onClick={this.changeCategory}>
                                <li data-category="react"  className={category=='react'?'active':''}>Reactli>
                                <li data-category="vue"  className={category=='vue'?'active':''}>Vueli>
                            ul>
                        CSSTransition>
                    }
                TransitionGroup>
...
### 6.5 containers/Home/index.tsx [#](#t6265-containershomeindextsx)
...
### 6.6 store/action-types.tsx [#](#t6366-storeaction-typestsx)
...
### 6.7 store/actions/home.tsx [#](#t6467-storeactionshometsx)
           ...
           if(!loading){
             ...
             getLessons(category,0,limit).then(result =>{
                 ...
                 if(code ==0){
                    ...
                    dispatch({type:types.REFRESH_HOME_LESSONS_LOADING,payload:false});
                    alert(error);
                 }
             });
           }
...
### 6.8 store/reducers/home.tsx [#](#t6568-storereducershometsx)
...
### 6.9 types/index.tsx [#](#t6669-typesindextsx)
...
### 6.10 components\Loading\index.tsx [#](#t67610-componentsloadingindextsx)
...
### 6.11 components\Loading\index.less [#](#t68611-componentsloadingindexless)
...
### 6.12 Home\components\List\index.tsx [#](#t69612-homecomponentslistindextsx)
          ...
          div>
          {
           list.length>0?list.map((item:any,index:number):any=>(
            <Link key={index} to={{pathname:`/detail/${item.id}`,state:item}}>
              ...
              div>
            Link>
           )):<div className="nodata">暂无数据div>
          }
          {
            loading?<Loading/>:<div className="load-more" onClick={this.props.getLessons}>加载更多div>
          }
        div>
      )
  }
...
### 6.13 Home\components\List\index.less [#](#t70613-homecomponentslistindexless)
...
## 7. 上拉加载和记录滚动条位置 [#](#t717-上拉加载和记录滚动条位置)

### 7.1 src/utils.tsx [#](#t7271-srcutilstsx)
...
### 7.2 Home/index.tsx [#](#t7372-homeindextsx)
...
### 7.3 Home/components/List/index.tsx [#](#t7473-homecomponentslistindextsx)

src/containers/Home/components/List/index.tsx

```js
{
   loading?<Loading/>:( !hasMore&&<div className="load-more">我是有底线的div>)
}
```

## 8.课程详情页 [#](#t758课程详情页)

### 8.1 src/containers/App.tsx [#](#t7681-srccontainersapptsx)
...
### 8.4 containers\Detail\index.tsx [#](#t7984-containersdetailindextsx)
...
### 8.5 containers\Detail\index.less [#](#t8085-containersdetailindexless)
...
### 9.1 Profile\index.tsx [#](#t8291-profileindextsx)
...
### 9.2 containers\Profile [#](#t8392-containersprofile)
...
### 10.1 src/containers/App.tsx [#](#t85101-srccontainersapptsx)
...
### 10.2 containers\Login\index.tsx [#](#t86102-containersloginindextsx)
...
### 10.3 containers\Login\index.less [#](#t87103-containersloginindexless)
...
### 11.1 src/containers/App.tsx [#](#t89111-srccontainersapptsx)
...
### 11.2 Reg\index.tsx [#](#t90112-regindextsx)
...
### 11.3 Reg\index.less [#](#t91113-regindexless)
...
### 12.1 server/app.js [#](#t93121-serverappjs)
...
### 12.2 src/api/index.tsx [#](#t94122-srcapiindextsx)
...
### 12.3 Login/index.tsx [#](#t95123-loginindextsx)
...
### 12.4 Profile/index.tsx [#](#t96124-profileindextsx)
        ...
        return (
            <div className="profile">
                <div className="profile-bg">
                    <img src={profile}/>
                    <div className="login-btn">
                    {this.props.user?this.props.user.username:<Link to="/login">登录Link>}
                    div>
                div>
            div>
        )
...
### 12.5 containers/Reg/index.tsx [#](#t97125-containersregindextsx)
    ...
    render() {
        return (
            <div className="login-panel">
                ...
                <input ref={input=>this.password=input} type="text" placeholder="密码" />
                <Link to="/login">前往登录Link>
                <button   onClick={this.handleReg} >注册button>
            div>
        )
    }
}
...
### 12.6 store/action-types.tsx [#](#t98126-storeaction-typestsx)
...
### 12.7 store/reducers/index.tsx [#](#t99127-storereducersindextsx)
...
### 12.8 types/index.tsx [#](#t100128-typesindextsx)
...
### 12.9 src/api/session.tsx [#](#t101129-srcapisessiontsx)
...
### 12.10 store/actions/session.tsx [#](#t1021210-storeactionssessiontsx)
...
### 12.11 store/reducers/session.tsx [#](#t1031211-storereducerssessiontsx)
...
## 13.受保护的路由 [#](#t10413受保护的路由)

### 13.1 src/containers/App.tsx [#](#t105131-srccontainersapptsx)
...
### 13.2 src/containers/Profile/index.tsx [#](#t106132-srccontainersprofileindextsx)
...
### 13.3 containers\PrivateRoute\index.tsx [#](#t107133-containersprivaterouteindextsx)
...
### 14.1 containers/Home/components/Swiper/index.tsx [#](#t109141-containershomecomponentsswiperindextsx)
...
### 14.2 Home/components/Swiper/SwiperItems.tsx [#](#t110142-homecomponentsswiperswiperitemstsx)
