...
let ThemeContext = React.createContextnull>(null);
...
### 2.2 多层高阶组件 [#](#t522-多层高阶组件)

#### 2.2.1 从localStorage中加载 [#](#t6221-从localstorage中加载)
...
## 3. render props [#](#t83-render-props)
