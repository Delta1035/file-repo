...
link: null
title: 珠峰架构师成长计划
description: server\settings.js
keywords: null
author: null
date: null
publisher: 珠峰架构师成长计划
stats: paragraph=16 sentences=344, words=1512
---
## 1.app.js [#](#t01appjs)
...
## 2. settings.js [#](#t12-settingsjs)

server\settings.js

```js
module.exports = {
  cookieSecret: 'zhufeng',
  dbUrl: "mongodb://127.0.0.1:27017/zhufengketang"
}
```

## 3. utils.js [#](#t23-utilsjs)
