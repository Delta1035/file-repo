...
### 2.1 安装npm包 [#](#t421-安装npm包)

```js
cnpm install  canvas  css express htmlparser2 --save
```

### 2.2 server\index.js [#](#t522-serverindexjs)
...
### 2.4 client\request.js [#](#t724-clientrequestjs)
...
### 2.5 client\render.js [#](#t825-clientrenderjs)
...
### 2.6 client\network.js [#](#t926-clientnetworkjs)
...
### 2.7 client\render.js [#](#t1027-clientrenderjs)
...
### 2.8 client\gpu.js [#](#t1128-clientgpujs)
...
### 2.9 client\main.js [#](#t1229-clientmainjs)
...
#### 3.1.2 request.js [#](#t16312-requestjs)
...
#### 3.2.2 request.js [#](#t19322-requestjs)
...
### 3.3 计算出DOM节点的样式 [#](#t2033-计算出dom节点的样式)

* 根据CSS的继承和层叠规则计算DOM节点的样式
* DOM节点的样式保存在了 `ComputedStyle`中

#### 3.3.1 index.html [#](#t21331-indexhtml)
...
#### 3.3.2 client\request.js [#](#t22332-clientrequestjs)
...
#### 3.4.1 index.html [#](#t24341-indexhtml)
...
#### 3.4.2 request.js [#](#t25342-requestjs)
...
#### 3.5.1 request.js [#](#t27351-requestjs)
...
#### 3.5.1 index.html [#](#t29351-indexhtml)
...
#### 3.5.2 client\request.js [#](#t30352-clientrequestjs)
...
#### 3.6.1 client\request.js [#](#t32361-clientrequestjs)
...
![](https://static.zhufengpeixun.com/tiles_1641120036119.png)

### 3.7.2 栅格化 [#](#t35372-栅格化)
...
#### 3.7.3 client\gpu.js [#](#t36373-clientgpujs)
...
#### 3.7.4 request.js [#](#t37374-requestjs)
...
#### 3.8.1 server\public\load.html [#](#t39381-serverpublicloadhtml)
...
#### 3.8.2 server\public\hello.css [#](#t40382-serverpublichellocss)
...
#### 3.8.3 server\public\hello.js [#](#t41383-serverpublichellojs)
...
#### 3.8.4 client\network.js [#](#t42384-clientnetworkjs)
...
#### 3.8.5 client\request.js [#](#t43385-clientrequestjs)
