...
#### 3.1.1 index.tsx [#](#t5311-indextsx)
...
#### 3.2.1 dva\index.tsx [#](#t7321-dvaindextsx)
...
#### 3.2.2 prefixNamespace.tsx [#](#t8322-prefixnamespacetsx)
...
#### 3.2.3 constants.tsx [#](#t9323-constantstsx)
...
#### 3.2.4 typings.tsx [#](#t10324-typingstsx)
...
## 4. 支持effects [#](#t114-支持effects)

### 4.1 使用 [#](#t1241-使用)

#### 4.1.1 index.tsx [#](#t13411-indextsx)
...
#### 4.2.1 dva\index.tsx [#](#t15421-dvaindextsx)
...
#### 4.2.2 prefixNamespace.tsx [#](#t16422-prefixnamespacetsx)
...
#### 5.1.1 index.tsx [#](#t19511-indextsx)
...
#### 5.2.1 dva\index.tsx [#](#t21521-dvaindextsx)
...
#### 5.2.2 router.tsx [#](#t22522-routertsx)
...
#### 6.1.1 index.tsx [#](#t25611-indextsx)
...
#### 6.2.1 dva\index.tsx [#](#t27621-dvaindextsx)
...
#### 6.2.2 src\dva\router.tsx [#](#t28622-srcdvaroutertsx)
...
## 7. dva-loading [#](#t297-dva-loading)
...
#### 7.1.1 index.tsx [#](#t31711-indextsx)
...
#### 7.2.1 dva\index.tsx [#](#t33721-dvaindextsx)
...
#### 7.2.2 dva-loading.tsx [#](#t34722-dva-loadingtsx)
...
#### 7.2.3 plugin.tsx [#](#t35723-plugintsx)
...
## 8. dynamic [#](#t368-dynamic)

* `dva/dynamic`是解决组件动态加载问题的方法。**8.1 使用[#](#t3781-使用)****8.1.1 index.tsx [#](#t38811-indextsx)*
...
**  8.2 实现 [#](#t3982-实现)****  8.2.1 dva\index.tsx [#](#t40821-dvaindextsx)**
...
**  8.2.2 dynamic.tsx [#](#t41822-dynamictsx)**
...
**  8.2.3 src\models\users.tsx [#](#t42823-srcmodelsuserstsx)**
...
**  8.2.4 routes\UserPage.tsx [#](#t43824-routesuserpagetsx)**
...
## 9. onAction中间件 [#](#t449-onaction中间件)

```js
cnpm i redux-logger -S
```

**  9.1 使用 [#](#t4591-使用)****  9.1.1 index.tsx [#](#t46911-indextsx)**
...
**  9.2 实现 [#](#t4792-实现)****  9.2.1 dva\index.tsx [#](#t48921-dvaindextsx)**
...
**  9.2.2 src\dva\plugin.tsx [#](#t49922-srcdvaplugintsx)**
...
**  9.2.3 src\redux-logger.tsx [#](#t50923-srcredux-loggertsx)**
...
## 10. stateChange [#](#t5110-statechange)

**  10.1 使用 [#](#t52101-使用)****  10.1.1 index.tsx [#](#t531011-indextsx)**
...
**  10.2 实现 [#](#t54102-实现)****  10.2.1 dva\index.tsx [#](#t551021-dvaindextsx)**
...
**  10.2.2 src\dva\plugin.tsx [#](#t561022-srcdvaplugintsx)**
...
**  11.2 实现 [#](#t60112-实现)****  11.2.1 dva\index.tsx [#](#t611121-dvaindextsx)**
...
**  11.2.2 src\dva\plugin.tsx [#](#t621122-srcdvaplugintsx)**
...
**  11.2.3 src\routes\UserPage.tsx [#](#t631123-srcroutesuserpagetsx)**
...
**  11.2.4 src\redux-undo.tsx [#](#t641124-srcredux-undotsx)**
...
## 12. extraEnhancers [#](#t6512-extraenhancers)

* [redux-persist](https://github.com/rt2zz/redux-persist)会将redux的store中的数据缓存到浏览器的localStorage中

**  12.1 使用 [#](#t66121-使用)****  12.1.1 index.tsx [#](#t671211-indextsx)**
...
**  12.2 实现 [#](#t68122-实现)****  12.2.1 dva\index.tsx [#](#t691221-dvaindextsx)**
...
**  12.2.2 plugin.tsx [#](#t701222-plugintsx)**
...
**  12.2.3 redux-persist\index.tsx [#](#t711223-redux-persistindextsx)**
...
**  12.2.4 persistReducer.tsx [#](#t721224-persistreducertsx)**
...
**  12.2.5 persistStore.tsx [#](#t731225-persiststoretsx)**
...
**  12.2.6 redux-persist\lib\storage.tsx [#](#t741226-redux-persistlibstoragetsx)**
...
**  12.2.7 redux-persist\lib\integration\react.tsx [#](#t751227-redux-persistlibintegrationreacttsx)**
...
**  13.1 使用 [#](#t77131-使用)****  13.1.1 index.tsx [#](#t781311-indextsx)**
...
**  13.2 实现 [#](#t79132-实现)****  13.2.1 dva\index.tsx [#](#t801321-dvaindextsx)**
...
**  13.2.2 dva\plugin.tsx [#](#t811322-dvaplugintsx)**
...
**  13.2.3 dva-immer.tsx [#](#t821323-dva-immertsx)**
...
## 14. onError [#](#t8314-onerror)

**  14.1 使用 [#](#t84141-使用)****  14.1.1 index.tsx [#](#t851411-indextsx)**
...
**  14.2 实现 [#](#t86142-实现)****  14.2.1 src\dva\index.tsx [#](#t871421-srcdvaindextsx)**
...
**  14.2.2 src\dva\plugin.tsx [#](#t881422-srcdvaplugintsx)**
