...
### 1.2 updateQueue [#](#t512-updatequeue)
...
### 1.4 collectEffectList [#](#t914-collecteffectlist)
...
![](https://static.zhufengpeixun.com/collectEffectListINIT1_1637041097456.jpg)

![](https://static.zhufengpeixun.com/collectEffectList_wan_cheng_BBB_1637041894303.jpg)

![](https://static.zhufengpeixun.com/collectEffectList_wan_cheng_DD1_1637041983781.jpg)

![](https://static.zhufengpeixun.com/collectEffectList_wan_cheng_A_1637042074823.jpg)
...
## 2.实现虚拟DOM [#](#t102实现虚拟dom)

* 虚拟DOM就是一个描述真实DOM的纯JS对象
* [babeljs](https://www.babeljs.cn/repl)

### 2.1 package.json [#](#t1121-packagejson)
...
### 2.2 src\index.js [#](#t1222-srcindexjs)
...
let element = <div key="title" id="title">divdiv>;
console.log(element);

```

### 2.3 ReactSymbols.js [#](#t1323-reactsymbolsjs)
...
## 3.开始WorkOnRoot [#](#t153开始workonroot)

* [开始WorkOnRoot](https://www.processon.com/diagraming/618dec810e3e744ad43d37a9)

### 3.1 从render到执行工作循环 [#](#t1631-从render到执行工作循环)

![](https://static.zhufengpeixun.com/render_dao_performSyncWorkOnRoot_1636637139987.jpg)

### 3.2 fiber结构 [#](#t1732-fiber结构)
...
### 3.3 src\index.js [#](#t1833-srcindexjs)
...
### 3.4 react-dom.js [#](#t1934-react-domjs)
...
### 3.5 ReactFiberRoot.js [#](#t2035-reactfiberrootjs)
...
### 3.6 ReactFiber.js [#](#t2136-reactfiberjs)
...
### 3.8 ReactUpdateQueue.js [#](#t2338-reactupdatequeuejs)
...
### 3.9 ReactFiberReconciler.js [#](#t2439-reactfiberreconcilerjs)
...
### 3.10 ReactFiberWorkLoop.js [#](#t25310-reactfiberworkloopjs)
...
## 4.创建createWorkInProgress [#](#t264创建createworkinprogress)
...
### 4.1 src\ReactFiberWorkLoop.js [#](#t2741-srcreactfiberworkloopjs)
...
### 4.2 src\ReactFiber.js [#](#t2842-srcreactfiberjs)
...
### 4.3 src\ReactFiberFlags.js [#](#t2943-srcreactfiberflagsjs)
...
### 5.1 src\index.js [#](#t3151-srcindexjs)
...
import React from './react';
import ReactDOM from './react-dom';
let element = <div key="title" id="title" style={{ border: '1px solid red' }}>divdiv>;
ReactDOM.render(
  element,
  document.getElementById('root')
);
...
### 5.2 ReactFiberWorkLoop.js [#](#t3252-reactfiberworkloopjs)
...
### 5.4 ReactFiberBeginWork.js [#](#t3454-reactfiberbeginworkjs)
...
### 5.5 ReactFiberCompleteWork.js [#](#t3555-reactfibercompleteworkjs)
...
### 5.6 ReactFiberFlags.js [#](#t3656-reactfiberflagsjs)
...
### 5.7 ReactDOMHostConfig.js [#](#t3757-reactdomhostconfigjs)
...
### 5.8 src\ReactDOMComponent.js [#](#t3858-srcreactdomcomponentjs)
...
### 5.9 src\ReactChildFiber.js [#](#t3959-srcreactchildfiberjs)
...
### 5.10 ReactFiber.js [#](#t40510-reactfiberjs)
...
### 5.11 ReactFiberCommitWork.js [#](#t41511-reactfibercommitworkjs)
...
## 6.单节点key相同,类型相同 [#](#t426单节点key相同类型相同)
...
### 6.2 public\index.html [#](#t4462-publicindexhtml)
...
### 6.3 src\index.js [#](#t4563-srcindexjs)
...
### 6.4 src\react-dom.js [#](#t4664-srcreact-domjs)
...
### 6.5 ReactFiberWorkLoop.js [#](#t4765-reactfiberworkloopjs)
...
### 6.6 ReactFiberFlags.js [#](#t4866-reactfiberflagsjs)
...
### 6.7 src\ReactFiberCommitWork.js [#](#t4967-srcreactfibercommitworkjs)
...
### 6.8 src\ReactDOMComponent.js [#](#t5068-srcreactdomcomponentjs)
...
### 6.9 src\ReactChildFiber.js [#](#t5169-srcreactchildfiberjs)
...
### 6.10 ReactDOMHostConfig.js [#](#t52610-reactdomhostconfigjs)
...
### 6.11 ReactFiberCompleteWork.js [#](#t53611-reactfibercompleteworkjs)
...
## 7.单节点key相同,类型不同 [#](#t547单节点key相同类型不同)

* 单节点key相同,类型不同，删除老节点，添加新节点

### 7.1 public\index.html [#](#t5571-publicindexhtml)
...
### 7.2 src\index.js [#](#t5672-srcindexjs)
...
## 8.单节点类型相同,key不同 [#](#t578单节点类型相同key不同)

* 3.类型相同,key不同,删除老节点，添加新节点

### 8.1 public\index.html [#](#t5881-publicindexhtml)
...
### 8.2 src\index.js [#](#t5982-srcindexjs)
...
## 9.原来多个节点，现在只有一个节点 [#](#t609原来多个节点现在只有一个节点)
...
### 9.1 public\index.html [#](#t6191-publicindexhtml)
...
### 9.2 src\index.js [#](#t6292-srcindexjs)
...
### 9.3 ReactChildFiber.js [#](#t6393-reactchildfiberjs)
...
### 9.4 src\ReactFiberCompleteWork.js [#](#t6494-srcreactfibercompleteworkjs)
...
### 9.5 ReactDOMHostConfig.js [#](#t6595-reactdomhostconfigjs)
...
## 11.多个节点的数量和key相同，有的type不同 [#](#t6711多个节点的数量和key相同有的type不同)
...
### 11.1 public\index.html [#](#t68111-publicindexhtml)
...
### 11.2 src\index.js [#](#t69112-srcindexjs)
...
### 11.3 src\ReactChildFiber.js [#](#t70113-srcreactchildfiberjs)
...
### 11.4 src\ReactFiberWorkLoop.js [#](#t71114-srcreactfiberworkloopjs)
...
### 11.5 ReactFiberCommitWork.js [#](#t72115-reactfibercommitworkjs)
...
## 12. 多个节点的类型和key全部相同，有新增元素 [#](#t7312-多个节点的类型和key全部相同有新增元素)

### 12.1 public\index.html [#](#t74121-publicindexhtml)
...
### 12.2 src\index.js [#](#t75122-srcindexjs)
...
### 12.3 src\ReactChildFiber.js [#](#t76123-srcreactchildfiberjs)
...
## 13. 7.多个节点的类型和key全部相同，有删除老元素 [#](#t7713-7多个节点的类型和key全部相同有删除老元素)

* 多个节点的类型和key全部相同，有删除老元素，删除老元素并更新老元素

### 13.1 public\index.html [#](#t78131-publicindexhtml)
...
### 13.2 src\index.js [#](#t79132-srcindexjs)
...
### 13.3 ReactChildFiber.js [#](#t80133-reactchildfiberjs)
...
## 14. 多个节点数量不同、key不同 [#](#t8114-多个节点数量不同key不同)
...
### 14.1 public\index.html [#](#t82141-publicindexhtml)
...
### 14.2 src\index.js [#](#t83142-srcindexjs)
...
### 14.3 src\ReactChildFiber.js [#](#t84143-srcreactchildfiberjs)
...
### 15.4 src\ReactFiberFlags.js [#](#t85154-srcreactfiberflagsjs)
...
### 15.5 src\ReactFiberWorkLoop.js [#](#t86155-srcreactfiberworkloopjs)
