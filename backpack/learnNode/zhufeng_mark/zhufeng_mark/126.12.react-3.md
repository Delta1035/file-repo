...
![](https://img.zhufengpeixun.com/1b7c2037153ec6d34c1e06ad04c6943d)

#### 2.1.2 按位或(|) [#](#t4212-按位或)

* 两个输入数的同一位只要有一个为1就是1

![](https://img.zhufengpeixun.com/df9f40a961da150a9eb65bc42533f9cb)
...
### 2.2 Fiber [#](#t622-fiber)

![](https://img.zhufengpeixun.com/a04c606956d8cc1341c7e5e2e40affec)

#### 2.2.1 Fiber是一种数据结构 [#](#t7221-fiber是一种数据结构)
...
#### 2.2.3 Fiber是一个执行单元 [#](#t9223-fiber是一个执行单元)
...
![](https://img.zhufengpeixun.com/09ac92e85389a9e3b7bfa5ec38ae8dda)
...
## 3.使用useReducer [#](#t113使用usereducer)

### 3.1 renderWithHooks [#](#t1231-renderwithhooks)

![](https://img.zhufengpeixun.com/0de1b5f3093e22ee8d72c1cc9d201198)

### 3.2 hooks更新 [#](#t1332-hooks更新)

![](https://img.zhufengpeixun.com/6c42e509155f6a11f0d9884581ce0fe7)

### 3.3 src\index.js [#](#t1433-srcindexjs)
...
## 4.实现useReducer [#](#t154实现usereducer)

### 4.1 src\index.js [#](#t1641-srcindexjs)
...
### 4.3 ReactFiberWorkLoop.js [#](#t1843-reactfiberworkloopjs)
...
### 4.4 ReactFiberBeginWork.js [#](#t1944-reactfiberbeginworkjs)
...
### 4.5 ReactFiberHooks.js [#](#t2045-reactfiberhooksjs)
...
## 5.useReducer更新 [#](#t215usereducer更新)

### 5.1 ReactFiberHooks.js [#](#t2251-reactfiberhooksjs)
...
### 5.2 ReactFiberWorkLoop.js [#](#t2352-reactfiberworkloopjs)
...
### 5.3 ReactFiberBeginWork.js [#](#t2453-reactfiberbeginworkjs)
...
### 6.2 src\ReactFiberHooks.js [#](#t2762-srcreactfiberhooksjs)
...
![](https://img.zhufengpeixun.com/9e2ae1e1704713f21f5bf6d9ac6dc990)

![](https://img.zhufengpeixun.com/5e3f17b04be8f6b223ddb55d0187acb4)
...
### 7.1 src\index.js [#](#t2971-srcindexjs)
...
### 7.2 ReactFiberFlags.js [#](#t3072-reactfiberflagsjs)
...
### 7.4 ReactFiberHooks.js [#](#t3274-reactfiberhooksjs)
...
### 7.5 ReactFiberWorkLoop.js [#](#t3375-reactfiberworkloopjs)
...
### 7.6 ReactFiberCommitWork.js [#](#t3476-reactfibercommitworkjs)
...
## 8.useLayoutEffect [#](#t358uselayouteffect)

![](https://img.zhufengpeixun.com/92f53cdf5c22c78086bef8ba7c825502)

### 8.1.src\index.js [#](#t3681srcindexjs)
...
### 8.2 src\ReactFiberHooks.js [#](#t3782-srcreactfiberhooksjs)
...
### 8.3 ReactFiberWorkLoop.js [#](#t3883-reactfiberworkloopjs)
...
### 8.4 ReactFiberCommitWork.js [#](#t3984-reactfibercommitworkjs)
...
### 9.1.src\index.js [#](#t4191srcindexjs)
...
### 9.2 ReactFiberHooks.js [#](#t4292-reactfiberhooksjs)
...
## 10.useMemo [#](#t4310usememo)

### 10.1.src\index.js [#](#t44101srcindexjs)
...
### 10.2 ReactFiberHooks.js [#](#t45102-reactfiberhooksjs)
