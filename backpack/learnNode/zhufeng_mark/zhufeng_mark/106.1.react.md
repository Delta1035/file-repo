...
### 3.3 JSX实现 [#](#t533-jsx实现)

### 3.3.1 package.json [#](#t6331-packagejson)
...
### 3.2 src\index.js [#](#t732-srcindexjs)
...
### 3.3 constants.js [#](#t833-constantsjs)
...
### 3.4 src\utils.js [#](#t934-srcutilsjs)
...
### 3.6 react-dom.js [#](#t1136-react-domjs)
...
![](https://upload-markdown-images.oss-cn-beijing.aliyuncs.com/xuan_ran_han_shu_zu_jian_1626351799850.jpg)

### 4.2 实现 [#](#t1442-实现)

#### 4.2.1 src\index.js [#](#t15421-srcindexjs)
...
#### 4.2.2 src\react-dom.js [#](#t16422-srcreact-domjs)
...
### 4.2 类(定义的)组件 [#](#t1742-类定义的组件)

* 也可以通过类定义组件
* 类组件的渲染是根据属性创建类的实例，并调用实例的render方法返回一个React元素

![](https://upload-markdown-images.oss-cn-beijing.aliyuncs.com/lei_zu_jian_xuan_ran_1626352042061.jpg)

#### 4.2.1 src\index.js [#](#t18421-srcindexjs)
...
#### 4.2.2 src\Component.js [#](#t19422-srccomponentjs)
...
#### 4.2.3 src\react.js [#](#t20423-srcreactjs)
...
#### 4.2.4 src\react-dom.js [#](#t21424-srcreact-domjs)
...
### 5.3 更新组新实现 [#](#t2453-更新组新实现)

#### 5.3.1 src\index.js [#](#t25531-srcindexjs)
...
#### 5.3.2 src\Component.js [#](#t26532-srccomponentjs)
...
#### 5.3.3 react-dom.js [#](#t27533-react-domjs)
...
### 6.2 src\utils.js [#](#t3062-srcutilsjs)
...
### 6.3 src\Component.js [#](#t3163-srccomponentjs)
...
### 6.4 src\event.js [#](#t3264-srceventjs)
...
### 6.5 src\react-dom.js [#](#t3365-srcreact-domjs)
...
### 7.1 为 DOM 元素添加 ref [#](#t3571-为-dom-元素添加-ref)
...
### 7.2 为 class 组件添加 Ref [#](#t3672-为-class-组件添加-ref)
...
### 7.4 ref实现 [#](#t3874-ref实现)

#### 7.4.1 src\constants.js [#](#t39741-srcconstantsjs)
...
#### 7.4.2 src\react.js [#](#t40742-srcreactjs)
...
#### 7.4.3 react-dom.js [#](#t41743-react-domjs)
...
![](https://upload-markdown-images.oss-cn-beijing.aliyuncs.com/react15_1626405471667.jpg)

### 8.1 src\index.js [#](#t4381-srcindexjs)
...
### 8.2 src\Component.js [#](#t4482-srccomponentjs)
...
### 8.3 src\react-dom.js [#](#t4583-srcreact-domjs)
...
## 9.子组件生命周期 [#](#t469子组件生命周期)

![](https://upload-markdown-images.oss-cn-beijing.aliyuncs.com/counterdomdiff_1626412843123.jpg)

### 9.1 src\index.js [#](#t4791-srcindexjs)
...
### 9.2 src\react-dom.js [#](#t4892-srcreact-domjs)
...
## 10.DOM-DIFF算法 [#](#t4910dom-diff算法)

* 只对同级节点进行对比，如果DOM节点跨层级移动，则React不会复用
* 不同类型的元素会产出不同的结构 ，会销毁老结构，创建新结构
* 可以通过 `key`标识移动的元素

![](https://upload-markdown-images.oss-cn-beijing.aliyuncs.com/domdiff_1626417725773.jpg)

### 10.1 src\index.js [#](#t50101-srcindexjs)
...
### 10.2 src\constants.js [#](#t51102-srcconstantsjs)
...
### 10.3 src\react.js [#](#t52103-srcreactjs)
...
### 10.4 src\react-dom.js [#](#t53104-srcreact-domjs)
...
## 11.新的生命周期 [#](#t5411新的生命周期)

![](https://upload-markdown-images.oss-cn-beijing.aliyuncs.com/react16_1626532331619.jpg)

### 11.1 getDerivedStateFromProps [#](#t55111-getderivedstatefromprops)
...
### 11.2 getSnapshotBeforeUpdate [#](#t56112-getsnapshotbeforeupdate)
...
#### 11.3.1 src\Component.js [#](#t581131-srccomponentjs)
...
## 12. Context(上下文) [#](#t5912-context上下文)

* 在某些场景下，你想在整个组件树中传递数据，但却不想手动地在每一层传递属性。你可以直接在 React 中使用强大的contextAPI解决上述问题
* 在一个典型的 React 应用中，数据是通过 props 属性自上而下（由父及子）进行传递的，但这种做法对于某些类型的属性而言是极其繁琐的（例如：地区偏好，UI 主题），这些属性是应用程序中许多组件都需要的。Context 提供了一种在组件之间共享此类值的方式，而不必显式地通过组件树的逐层传递 props

![](https://upload-markdown-images.oss-cn-beijing.aliyuncs.com/contextapi_1626532435193.gif)

### 12.1 src\index.js [#](#t60121-srcindexjs)
    ...
    <Consumer>
      {
        (contextValue) => (
          <div style={{ ...style, border: `5px solid ${contextValue.color}` }}>
            Content
            <button style={{ color: 'red' }} onClick={() => contextValue.changeColor('red')}>变红button>
            <button style={{ color: 'green' }} onClick={() => contextValue.changeColor('green')}>变绿button>
          div>
        )
      }
    Consumer>
...
### 12.2 src\constants.js [#](#t61122-srcconstantsjs)
...
### 12.3 src\Component.js [#](#t62123-srccomponentjs)
...
### 12.4 src\react.js [#](#t63124-srcreactjs)
...
### 12.5 src\react-dom.js [#](#t64125-srcreact-domjs)
...
### 13.1 cra支持装饰器 [#](#t66131-cra支持装饰器)

#### 13.1.1 安装 [#](#t671311-安装)

```js
npm i react-app-rewired customize-cra @babel/plugin-proposal-decorators -D
```

#### 13.1.2 修改package.json [#](#t681312-修改packagejson)
...
#### 13.1.3 config-overrides.js [#](#t691313-config-overridesjs)
...
#### 13.1.4 jsconfig.json [#](#t701314-jsconfigjson)
...
## 14. render props [#](#t7314-render-props)
...
### 15.1 src\index.js [#](#t79151-srcindexjs)
...
### 15.2 src\constants.js [#](#t80152-srcconstantsjs)
...
### 15.3 src\utils.js [#](#t81153-srcutilsjs)
...
### 15.4 src\react.js [#](#t82154-srcreactjs)
...
### 15.5 src\react-dom.js [#](#t83155-srcreact-domjs)
...
## 16.Portal [#](#t8416portal)

* React v16增加了对Portal的直接支持
* 它可以把JSX渲染到一个单独的DOM节点中

### 16.1 src\index.js [#](#t85161-srcindexjs)
...
### 16.2 src\react-dom.js [#](#t86162-srcreact-domjs)
