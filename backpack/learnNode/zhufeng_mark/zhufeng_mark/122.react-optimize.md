...
date: null
publisher: 珠峰架构师成长计划
stats: paragraph=51 sentences=201, words=1680
---
## 1.初始化项目
  ...
  render(){
    ...
    return (
      <div>
        ...
        <button onClick={()=>this.add(1)}>+1button>
        <button onClick={()=>this.add(0)}>+0button>
...
export default class Home extends React.Component{
    ...
    render(){
        return (
            <ul>
              <button onClick={ this.handleClick }>点击button>
              {
