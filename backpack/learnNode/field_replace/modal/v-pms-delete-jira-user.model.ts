...
@model({
  settings: {
    idInjection: false,
    postgresql: {schema: 'pms', table: 'v_pms_delete_jira_user'}
  }
})
export class VPmsDeleteJiraUser extends Entity {
  @property({
    type: 'number',
    scale: 0,
  ...
  constructor(data?: Partial<VPmsDeleteJiraUser>) {
    super(data);
  }
}

export interface VPmsDeleteJiraUserRelations {
  // describe navigational properties here
}

export type VPmsDeleteJiraUserWithRelations = VPmsDeleteJiraUser & VPmsDeleteJiraUserRelations;
