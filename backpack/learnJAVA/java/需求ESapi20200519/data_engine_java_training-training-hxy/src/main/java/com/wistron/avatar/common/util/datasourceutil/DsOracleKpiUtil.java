...
public class DsOracleKpiUtil {
    ...
    public SqlSessionFactory oracleSessionFactory(@Qualifier("oracleKpiDataSource") DataSource dataSource)
            throws Exception {
    ...
    public DataSourceTransactionManager oracleTransactionManager(@Qualifier("oracleKpiDataSource") DataSource dataSource) {
        return new DataSourceTransactionManager(dataSource);
    }

    @Bean(name = "oracleKpiSessionTemplate")
    public SqlSessionTemplate oracleSessionTemplate(@Qualifier("oracleKpiSessionFactory") SqlSessionFactory sqlSessionFactory) throws Exception {
